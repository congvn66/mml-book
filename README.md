# My Journey of Learning Mathematics for Artificial Intelligence

This repository documents a structured personal journey through mathematics for Machine Learning and Deep Learning. It contains solutions, derivations, and notes from textbooks, lecture notes, and online courses. All content is implemented in Jupyter Notebooks.

# Folder Description
**linear algebra** - my solution of chapter 2, 3, 4 in *Mathematics for Machine Learning*, M. P. Deisenroth, A. A. Fasial, C. S. Ong.

**vector calculus** - my solution of chapter 5 in *Mathematics for Machine Learning*, M. P. Deisenroth, A. A. Fasial, C. S. Ong.

**probability** - my solution for recitation problems, problem sets of *Probabilistic Systems Analysis and Applied Probability*, MIT OCW. *(still working on it!)*
